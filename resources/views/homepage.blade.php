...
@section('content')
	...
	<div class="row row-0 walletSection">
		...
		<div id="second" class="col-xs-12 col-sm-12 col-md-9 withContent my-auto">
			<h1 class="content-title pl-70 landing-title">Create and sell digital arts & collectibles secured with Binance Smart Chain</h1>
			<div class="btnGroup">
				<a href="{{ url('/create') }}" class="btn btnPrimary">Create</a>
				<a href="{{ route('marketplace') }}" class="btn btnSecondary">Explore</a>
			</div>
		</div>
		...
		<div id="first" class="col-xs-12 col-sm-12 col-md-3 withBg color-change-3x">
			<div class="posBtn z-2">
				<a class="btn content-title" href="{{ url('/connect') }}" id="connectWallet"><i class="fas fa-angle-double-right"></i> Connect Wallet</a>
			</div>
