...
<div class="row row-0 walletSection connect-wallet">
    ...
    <div class="col-12 col-md-6 withContent my-auto">
        <div>
            <a class="btn content-title" href="{{ url()->previous() }}" id="box">Go back <i
        ...
        <p class="text-bold pl-40">We do not own your private keys and cannot access your funds without your
            confirmation.</p>
    </div>
