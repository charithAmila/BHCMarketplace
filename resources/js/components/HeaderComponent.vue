  ...
  <div>
    <nav class="navbar navbar-expand-lg navbar-light custom-navbar">
      ...
      <div class="right-nav d-none d-md-block default-nav">
        ...
        >
          <span v-if="notifications.length>0" class="count">{{this.notifications.length}}</span>
          <img
        ...
        <a v-if="!auth_check" :href="connect_route" class="btn nav-connect">{{
          account
        }}</a>
      </div>
      ...
      >
        ...
        <div class="menu-options">
          ...
          <a id="edit-profile-btn" href="javascript:void(0)" @click="getUser()"
            >Edit profile</a
          >
  ...
  methods: {
   async  getNotifications() {
    ...
    bidEvent() {
      ...
      var channel = pusher.subscribe("bid-channel_" + this.current_user.id);
