    ...
    <div>
        <nav class="navbar navbar-expand-lg navbar-light custom-navbar">
            ...
            <div class="right-nav d-none d-md-block default-nav">
                ...
                >
                    <span v-if="this.notifications.length > 0 && this.viewed ==false" class="count">{{
            ...
            <div class="right-nav d-sm-block d-md-none d-lg-none default-nav">
                ...
                <a
                    ...
                    @click.prevent="setViewed()"
                >
                    <span v-if="this.notifications.length > 0 && this.viewed==false" class="count" @click="setViewed()">{{
                        this.notifications.length
                    }}</span>
                    <img
                        :src="asset_url + 'images/logo2.png'"
